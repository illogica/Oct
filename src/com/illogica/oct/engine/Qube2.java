...
public class Qube2 extends Node{
    ...
    public Qube2(Octant o, Material mat, int unitDepth){
        updateGeometry(o, mat, unitDepth);
    }
    
    public void updateMaterial(Material material){
        //boolean[] v = o.getVisibleQuads();
        for(int i=0; i<6; i++){
            //if(v[i]){
    ...
    private void updateGeometry(Octant o, Material mat, int unitDepth){
    ...
    private QuadV4 quadBySide(int side, int unitDepth){
        switch(side){
            case 0:
                return new QuadV4(v7, v4, v0, v3, o, side, unitDepth);
            case 1:
                return new QuadV4(v4, v5, v1, v0, o, side, unitDepth);
            case 2:
                return new QuadV4(v5, v6, v2, v1, o, side, unitDepth);
            case 3:
                return new QuadV4(v6, v7, v3, v2, o, side, unitDepth);
            case 4:
                return new QuadV4(v3, v0, v1, v2, o, side, unitDepth);
            case 5:
                return new QuadV4(v6, v5, v4, v7, o, side, unitDepth);
            default:
